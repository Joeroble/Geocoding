    ...
    private fun showMapForPlace(placeName: String) {
        ...
        try {
            ...
            if (addresses.isNotEmpty()) {
                ...
                Log.d(TAG, "No places for string $placeName")
                Toast.makeText(
                    this,
        ...
        Log.e(TAG, "Unable to geocode place $placeName")
        Toast.makeText(this, "Sorry, unable to geocode.  Are you online?", Toast.LENGTH_LONG).show()
        }
    }
